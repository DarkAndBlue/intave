...
public final class CachedResource {
  ...
  public InputStream read() {
    ...
    try {
      FileInputStream fileInputStream = new FileInputStream(tempFileStore());
...
//      throw new IllegalStateException(e);
    ...
    try {
      ...
      FileOutputStream outputStream = new FileOutputStream(tempFileStore());
...
//      exception.printStackTrace();
  ...
  private File tempFileStore() {
    ...
    return new File(intaveTempDirectory, resourceId());
  }
